  ...
  return (
    <SolutionLayout title="Стек">
      <div className={styles.box}>
        ...
        <Button text="Добавить" onClick={addElem} disabled={!value || isAdd || isDelete || stack.getSize() >= stack.getMaxSize()}/>
        <Button text="Удалить" onClick={deleteElem} disabled={stack.getSize() === 0 || isAdd || isDelete}/>
        <Button text="Очистить" extraClass="ml-30" onClick={deleteAll} disabled={stack.getSize() === 0 || isAdd || isDelete}/>
      </div>
